...
impl<T: RealField, B: EvalBasis<T, T, NumComponents = U1, NumBasis = Dyn>, const D: usize> EvalBasis<T, [T; D]> for MultiProd<T, B, D> {
...
impl<T: RealField + Copy, B: EvalGrad<T, T, 1, NumBasis = Dyn>, const D: usize> EvalGrad<T, [T; D], D> for MultiProd<T, B, D> {

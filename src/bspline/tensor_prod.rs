...
impl<T: RealField, X, B1: BsplineBasis<T, X>, B2: BsplineBasis<T, X>> Prod<T, X, B1, B2> {
...
impl <T: RealField, X: Copy, B1: BsplineBasis<T, X>, B2: BsplineBasis<T, X>> BsplineBasis<T, [X; 2]> for Prod<T, X, B1, B2>

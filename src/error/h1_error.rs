...
impl<'a, M> H1Norm<'a, M> {
        ...
        Const<D>: DimMin<Const<D>, Output=Const<D>>
    {
        ...
        l2.norm_squared(u, quad) + l2.norm_squared(u_grad, quad)
    }
